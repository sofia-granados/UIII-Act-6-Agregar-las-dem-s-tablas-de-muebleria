...
urlpatterns = [
    ...
    path('sucursal/detalle/<int:id_sucursal>/', views.detalle_sucursal, name='detalle_sucursal'),
    ...
    path('producto/detalle/<int:id_producto>/', views.detalle_producto, name='detalle_producto'),
    ...
    path('proveedor/detalle/<int:id_proveedor>/', views.detalle_proveedor, name='detalle_proveedor'),
    ...
    path('cliente/detalle/<int:id_cliente>/', views.detalle_cliente, name='detalle_cliente'),
